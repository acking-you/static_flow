//! Proxy configuration storage: proxy config/base-row load/list/get,
//! endpoint-check application, per-node overrides, binding resolution, scope
//! metadata, and provider-proxy resolution context, plus the `AdminProxyStore`
//! impl.
...
impl PostgresControlRepository {
    pub(crate) async fn load_admin_proxy_configs_cached(
        &self,
    ...
    pub(crate) async fn load_admin_proxy_binding_cached(
        &self,
        provider_type: &str,
    ) -> anyhow::Result<AdminProxyBinding> {
        let Some(cache) = self.request_cache.as_ref() else {
    ...
    pub(crate) async fn invalidate_proxy_metadata_cache(&self) {
        let Some(cache) = self.request_cache.as_ref() else {
            return;
        };
        let scope = self.proxy_scope.cache_key_segment();
    ...
    pub(crate) async fn current_proxy_metadata_generation(&self) -> i64 {
        let codex = self
    ...
    pub(crate) async fn list_admin_proxy_config_base_rows(
        &self,
    ) -> anyhow::Result<Vec<AdminProxyConfig>> {
        self.ensure_connection_alive()?;
        let rows = self
    ...
    pub(crate) async fn list_admin_proxy_configs_rows(
        &self,
    ) -> anyhow::Result<Vec<AdminProxyConfig>> {
    ...
    pub(crate) async fn get_admin_proxy_config_base_row(
        &self,
        proxy_id: &str,
    ) -> anyhow::Result<Option<AdminProxyConfig>> {
        self.ensure_connection_alive()?;
    ...
    pub(crate) async fn get_admin_proxy_config_row(
        &self,
        proxy_id: &str,
    ) -> anyhow::Result<Option<AdminProxyConfig>> {
        let Some(mut proxy) = self.get_admin_proxy_config_base_row(proxy_id).await? else {
    ...
    pub(crate) async fn list_proxy_endpoint_check_rows(
        &self,
    ) -> anyhow::Result<Vec<ProxyEndpointCheckRow>> {
        self.ensure_connection_alive()?;
        let rows = self
            .client
            .query(
    ...
    pub(crate) async fn apply_proxy_endpoint_checks_to_configs(
        &self,
    ...
    pub(crate) async fn apply_proxy_endpoint_checks_to_config(
        &self,
    ...
    pub(crate) async fn list_proxy_config_node_overrides(
        &self,
    ...
    pub(crate) async fn get_proxy_config_node_override(
        &self,
        proxy_id: &str,
    ...
    pub(crate) async fn patch_admin_proxy_config_node_override(
        &self,
        proxy_id: &str,
        patch: AdminProxyConfigPatch,
    ) -> anyhow::Result<Option<AdminProxyConfig>> {
    ...
    pub(crate) fn apply_proxy_scope_metadata(
        &self,
        proxy: &mut AdminProxyConfig,
    ...
    pub(crate) async fn load_admin_proxy_binding_row(
        &self,
        provider_type: &str,
    ) -> anyhow::Result<AdminProxyBinding> {
        let proxy_configs_by_id = self
    ...
    pub(crate) async fn load_admin_proxy_binding_from_configs(
        &self,
        provider_type: &str,
    ...
    pub(crate) async fn load_provider_proxy_resolution_context(
        &self,
        provider_type: &str,
