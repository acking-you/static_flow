//! Codex account storage: account view caches, admin-account list/summary/
//! page/filter, route-candidate queries, view-context resolution, record
//! conversions, upsert, and import-job rows, plus the `AdminCodexAccountStore`
//! impl.
...
impl PostgresControlRepository {
    pub(crate) async fn load_codex_account_views_cached(
        &self,
    ...
    pub(crate) async fn load_codex_account_auth_cached(
        &self,
        account_name: &str,
    ...
    pub(crate) async fn list_codex_admin_account_rows(
        &self,
    ) -> anyhow::Result<Vec<CodexAdminAccountListRow>> {
        self.ensure_connection_alive()?;
        let rows = self
            .client
            .query(
    ...
    pub(crate) async fn admin_codex_accounts_summary(
        &self,
    ...
    pub(crate) async fn list_codex_admin_account_rows_page(
        &self,
        page: AdminPageRequest,
    ...
    pub(crate) async fn list_codex_admin_account_rows_filtered_page(
        &self,
        query: &AdminCodexAccountPageQuery,
        page: AdminPageRequest,
    ) -> anyhow::Result<(Vec<CodexAdminAccountListRow>, usize)> {
    ...
    pub(crate) async fn get_codex_account_row(
        &self,
        name: &str,
    ...
    pub(crate) async fn list_codex_route_candidate_rows(
        &self,
    ...
    pub(crate) async fn list_codex_route_candidate_rows_by_names(
        &self,
        account_names: &[String],
    ) -> anyhow::Result<Vec<CodexRouteCandidateRow>> {
        if account_names.is_empty() {
    ...
    pub(crate) async fn load_codex_admin_account_view_context(
        &self,
    ...
    pub(crate) fn resolve_codex_account_proxy_view_with_context(
        &self,
    ...
    pub(crate) fn admin_codex_account_from_list_row_with_context(
        &self,
    ...
    pub(crate) fn admin_codex_account_from_record_with_context(
        &self,
    ...
    pub(crate) async fn admin_codex_account_from_record(
        &self,
        record: &CodexAccountRecord,
    ) -> anyhow::Result<AdminCodexAccount> {
        let context = self.load_codex_admin_account_view_context().await?;
    ...
    pub(crate) async fn upsert_codex_account(
        &self,
        record: &CodexAccountRecord,
    ) -> anyhow::Result<()> {
        self.ensure_connection_alive()?;
    ...
    pub(crate) async fn load_codex_import_job_summary_row(
        &self,
        job_id: &str,
    ) -> anyhow::Result<Option<AdminCodexImportJobSummary>> {
        self.ensure_connection_alive()?;
    ...
    pub(crate) async fn load_codex_import_job_items_rows(
        &self,
        job_id: &str,
