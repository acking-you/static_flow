//! Usage accounting storage: usage proxy attribution resolution/build and
//! batched usage-rollup application, plus the `UsageEventSink` impl.
...
impl PostgresControlRepository {
    ...
    pub(crate) async fn build_usage_proxy_attribution(
        &self,
        provider: &str,
        account_name: &str,
    ) -> anyhow::Result<Option<UsageProxyAttribution>> {
    ...
    pub(crate) async fn build_codex_usage_proxy_attribution(
        &self,
        account_name: &str,
    ) -> anyhow::Result<Option<UsageProxyAttribution>> {
    ...
    pub(crate) async fn build_kiro_usage_proxy_attribution(
        &self,
        account_name: &str,
    ) -> anyhow::Result<Option<UsageProxyAttribution>> {
    ...
    pub(crate) async fn apply_usage_rollups_batch(
        &self,
        events: &[UsageEvent],
    ) -> anyhow::Result<()> {
