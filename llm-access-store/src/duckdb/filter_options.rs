//! Usage filter-option discovery: distinct filter values from a path, a
//! connection, or the tiered catalog, with SQL generation and result merging.

#[allow(unused_imports, reason = "submodule inherits parent facade imports via glob")]
use super::*;

#[cfg(feature = "duckdb-runtime")]
pub(crate) fn catalog_filter_options_query_from_usage_query(
...
#[cfg(feature = "duckdb-runtime")]
pub(crate) fn usage_filter_options_query_for_catalog_field(
    query: &UsageEventQuery,
    field_name: UsageCatalogFieldName,
) -> UsageEventQuery {
...
#[cfg(feature = "duckdb-runtime")]
pub(crate) fn list_usage_filter_options_from_path(
    path: &Path,
    query: &UsageEventQuery,
...
#[cfg(feature = "duckdb-runtime")]
pub(crate) fn list_usage_filter_options_from_conn(
...
#[cfg(feature = "duckdb-runtime")]
pub(crate) fn list_usage_filter_options_from_tiered(
...
#[cfg(feature = "duckdb-runtime")]
pub(crate) fn fetch_usage_filter_options_from_conn(
    conn: &duckdb::Connection,
    query: &UsageEventQuery,
) -> anyhow::Result<UsageFilterOptions> {
...
#[cfg(feature = "duckdb-runtime")]
pub(crate) fn usage_filter_options_sql(columns: &HashSet<String>, table_alias: &str) -> String {
    let model_sql =
...
#[cfg(feature = "duckdb-runtime")]
pub(crate) fn usage_filter_options_where_sql(
...
#[cfg(feature = "duckdb-runtime")]
pub(crate) fn merge_usage_filter_options(
...
#[cfg(feature = "duckdb-runtime")]
pub(crate) fn assign_usage_filter_option_values(
...
#[cfg(feature = "duckdb-runtime")]
pub(crate) fn merge_missing_usage_filter_options(
