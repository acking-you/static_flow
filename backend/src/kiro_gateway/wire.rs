...
pub trait EventPayload: Sized {
    fn from_frame(
        frame: &crate::kiro_gateway::parser::frame::Frame,
    ) -> crate::kiro_gateway::parser::error::ParseResult<Self>;
}
...
impl Event {
    pub fn from_frame(
        ...
        match message_type {
            ...
            other => Err(crate::kiro_gateway::parser::error::ParseError::InvalidMessageType(
                other.to_string(),
            )),
        }
    }
    ...
    fn parse_event(
        ...
        match EventType::from_str(frame.event_type().unwrap_or("unknown")) {
