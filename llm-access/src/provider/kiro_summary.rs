//! Kiro last-message and tool-result summarization helpers for usage logging.

#[allow(unused_imports, reason = "submodule inherits parent facade imports via glob")]
use super::*;

pub(crate) fn extract_last_message_from_kiro_messages(payload: &MessagesRequest) -> Option<String> {
...
pub(crate) fn collect_kiro_tool_name_map(
...
pub(crate) fn append_kiro_message_summary_parts(
    content: &Value,
...
pub(crate) fn summarize_text(text: &str) -> Option<String> {
