//! Codex model catalog: OpenAI/public model responses and upstream model-list
//! fetch/parse.
...
pub(crate) fn codex_models_json_response(
    body: Vec<u8>,
...
pub(crate) async fn fetch_codex_models_payload(
    route: &ProviderCodexRoute,
    route_store: Arc<dyn ProviderRouteStore>,
    request_headers: &HeaderMap,
    query: &str,
...
pub(crate) fn codex_models_client_version(
    query: &str,
    default_codex_client_version: &str,
) -> String {
    query
...
pub(crate) async fn send_codex_models_request(
...
pub(crate) async fn parse_codex_models_payload(
...
pub(crate) fn summarize_body_hint(body: &[u8]) -> String {
