...
pub(crate) struct AdminUsageEventView {
    ...
    pub(crate) same_account_retry_count: u64,
    pub(crate) same_account_retry_delay_ms: i64,
    pub(crate) same_account_retry_reasons: Vec<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl From<&UsageEvent> for AdminUsageEventView {
    fn from(value: &UsageEvent) -> Self {
        ...
        Self {
            ...
            same_account_retry_count: value.retry.same_account_retry_count,
            same_account_retry_delay_ms: value.retry.same_account_retry_delay_ms,
            same_account_retry_reasons: value.retry.same_account_retry_reasons.clone(),
