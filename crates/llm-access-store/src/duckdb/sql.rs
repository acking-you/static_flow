...
pub fn compact_copy_usage_events_sql(columns: &HashSet<String>) -> String {
    let select = vec![
        ...
        compact_source_column_expr(columns, "same_account_retry_count", "CAST(0 AS BIGINT)"),
        compact_source_column_expr(columns, "same_account_retry_delay_ms", "CAST(0 AS BIGINT)"),
        compact_source_column_expr(columns, "same_account_retry_reasons_json", "'[]'"),
...
fn usage_event_base_select_exprs(
    ...
    vec![
        ...
        usage_event_column_expr(columns, "same_account_retry_count", "CAST(0 AS BIGINT)"),
        usage_event_column_expr(columns, "same_account_retry_delay_ms", "CAST(0 AS BIGINT)"),
        usage_event_column_expr(columns, "same_account_retry_reasons_json", "'[]'"),
