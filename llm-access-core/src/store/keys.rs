...
pub(crate) fn summarize_admin_keys(keys: &[AdminKey]) -> AdminKeysSummary {
...
pub(crate) fn admin_key_matches_query(key: &AdminKey, query: &AdminKeyPageQuery) -> bool {
...
pub(crate) fn apply_admin_key_query(keys: &mut Vec<AdminKey>, query: &AdminKeyPageQuery) {
