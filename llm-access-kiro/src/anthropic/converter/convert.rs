...
pub(crate) fn web_search_tool_result_text(
...
#[cfg(test)]
pub(crate) fn convert_request_with_validation(
    req: &MessagesRequest,
...
pub(crate) fn merge_current_user_messages(
    messages: &[&super::types::Message],
    model_id: &str,
...
pub(crate) fn merge_user_messages(
    messages: &[&super::types::Message],
    model_id: &str,
...
pub(crate) fn ensure_document_content_placeholder(
    content: &mut String,
...
pub(crate) fn merge_assistant_messages(
    messages: &[&super::types::Message],
    tool_name_map: &mut HashMap<String, String>,
) -> Result<HistoryAssistantMessage, ConversionError> {
    if messages.len() == 1 {
