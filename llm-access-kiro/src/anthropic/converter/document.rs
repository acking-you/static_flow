...
pub(crate) fn normalize_user_document_block(
...
pub(crate) fn normalize_document_block_payload(
    block: &serde_json::Map<String, serde_json::Value>,
    message_index: usize,
    block_index: usize,
) -> Result<serde_json::Value, ConversionError> {
...
pub(crate) fn document_media_type_supports_text_source(media_type: &str) -> bool {
    matches!(media_type, "text/plain" | "text/markdown" | "text/html" | "text/csv")
}
pub(crate) fn document_format_from_media_type(media_type: &str) -> Option<&'static str> {
    match media_type {
...
pub(crate) fn normalize_document_name(
    raw_name: Option<&str>,
    media_type: &str,
    data: &str,
) -> String {
...
pub(crate) fn sanitize_document_name(name: &str) -> String {
...
pub(crate) fn generate_document_name(media_type: &str, data: &str) -> String {
...
pub(crate) fn kiro_document_from_source(
    name: String,
...
pub(crate) fn kiro_document_from_block(
    name: Option<String>,
