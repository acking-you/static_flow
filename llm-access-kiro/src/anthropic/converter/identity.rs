...
pub(crate) fn requested_model_identity_id(model: &str) -> &str {
    model.strip_suffix("-thinking").unwrap_or(model)
}
pub(crate) fn requested_model_identity_name(model: &str) -> Option<&'static str> {
...
pub(crate) fn response_model_identity(model: &str) -> Option<ResponseModelIdentity> {
...
pub(crate) fn anthropic_identity_override(requested_model: &str) -> String {
...
pub(crate) fn normalize_claude_code_model_identity(
    content: String,
    requested_model: &str,
) -> String {
...
pub(crate) fn strip_volatile_claude_code_billing_header(content: String) -> String {
    content
        .lines()
...
pub(crate) fn is_claude_code_billing_header_text(content: &str) -> bool {
