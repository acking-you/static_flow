...
pub(crate) fn validate_messages_request(req: &MessagesRequest) -> Result<(), ConversionError> {
...
pub(crate) fn validate_user_message_content(
...
pub(crate) fn validate_assistant_message_content(
    content: &serde_json::Value,
    message_index: usize,
) -> Result<(), ConversionError> {
    match content {
