...
pub(crate) fn normalize_tool_description(name: &str, description: &str) -> Option<String> {
...
pub(crate) fn extract_structured_output_schema(req: &MessagesRequest) -> Option<serde_json::Value> {
    req.output_config
        .as_ref()
...
pub(crate) fn make_structured_output_tool_name(existing_tools: &[Tool]) -> String {
...
pub(crate) fn structured_output_instruction(tool_name: &str) -> String {
    format!(
