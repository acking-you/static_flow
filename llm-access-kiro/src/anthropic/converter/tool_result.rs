...
pub(crate) fn extract_tool_result_attachments(
...
pub(crate) fn extract_tool_result_attachments_from_value(
...
pub(crate) fn extract_tool_result_content_from_value(value: &serde_json::Value) -> String {
    match value {
...
pub(crate) fn parse_stringified_tool_result_content(
    content: &Option<serde_json::Value>,
...
pub(crate) fn looks_like_tool_result_content_block(value: &serde_json::Value) -> bool {
    matches!(
