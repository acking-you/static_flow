...
pub(crate) fn rewrite_duplicate_tool_use_ids(
...
pub(crate) fn collect_existing_tool_use_ids(messages: &[super::types::Message]) -> HashSet<String> {
...
pub(crate) fn next_rewritten_tool_use_id(
    original_id: &str,
    occurrence: usize,
...
pub(crate) fn collect_history_tool_names(history: &[Message]) -> Vec<String> {
...
pub(crate) fn create_placeholder_tool(name: &str) -> Tool {
    Tool {
...
pub(crate) fn truncate_tool_name_prefix(name: &str, prefix_max: usize) -> &str {
...
pub(crate) fn make_hashed_tool_name_alias(original_name: &str, visible_base: &str) -> String {
...
pub(crate) fn map_tool_name(name: &str, tool_name_map: &mut HashMap<String, String>) -> String {
